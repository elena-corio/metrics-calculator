...
def test_volume_to_envelope_factor_normal():
    ...
    # total_volume = 150, envelope_area = 50, factor = 150 / 50 = 3.0
    assert calculate_volume_to_envelope(facades) == pytest.approx(3.0)

def test_volume_to_envelope_factor_zero_envelope():
    facades = []
    # envelope_area = 0, should return 0
    assert calculate_volume_to_envelope(facades) == 0
